  ...
  return (
    <div className="card-product">
      <div className="productCard_imgContainer">
        <img className="productCard_img" src={'http://localhost:5000/' + product.img} alt="product_name"/>
      
      </div>
      <div className='productCard_like'><FaHeart className='icons_like' style={{
          color: isActive ? '#FFCC1A' : '',
